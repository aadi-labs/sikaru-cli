...
pub enum PlanTraceImportRequestMode {
    Historical,
    Selective,
...
impl Serialize for PlanTraceImportRequestMode {
...
impl<'de> Deserialize<'de> for PlanTraceImportRequestMode {
...
impl fmt::Display for PlanTraceImportRequestMode {
