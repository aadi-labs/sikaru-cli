...
pub enum SessionInputReasoningEffort {
    None,
    Minimal,
    Low,
    Medium,
...
impl Serialize for SessionInputReasoningEffort {
...
impl<'de> Deserialize<'de> for SessionInputReasoningEffort {
...
impl fmt::Display for SessionInputReasoningEffort {
