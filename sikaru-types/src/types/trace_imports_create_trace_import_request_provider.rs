...
pub enum CreateTraceImportRequestProvider {
    Langsmith,
    Langfuse,
    Braintrust,
    Logfire,
...
impl Serialize for CreateTraceImportRequestProvider {
...
impl<'de> Deserialize<'de> for CreateTraceImportRequestProvider {
...
impl fmt::Display for CreateTraceImportRequestProvider {
