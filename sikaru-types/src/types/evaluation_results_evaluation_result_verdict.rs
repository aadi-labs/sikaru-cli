...
pub enum EvaluationResultVerdict {
    Pass,
    Fail,
    UnableToJudge,
    Error,
...
impl Serialize for EvaluationResultVerdict {
...
impl<'de> Deserialize<'de> for EvaluationResultVerdict {
...
impl fmt::Display for EvaluationResultVerdict {
