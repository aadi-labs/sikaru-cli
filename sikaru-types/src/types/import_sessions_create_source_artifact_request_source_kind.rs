...
pub enum CreateSourceArtifactRequestSourceKind {
    WorkflowJson,
    Langgraph,
    N8NJson,
    YamlDag,
...
impl Serialize for CreateSourceArtifactRequestSourceKind {
...
impl<'de> Deserialize<'de> for CreateSourceArtifactRequestSourceKind {
...
impl fmt::Display for CreateSourceArtifactRequestSourceKind {
