...
pub struct CreateReleaseWatchRequest {
...
impl CreateReleaseWatchRequest {
    pub fn builder() -> CreateReleaseWatchRequestBuilder {
        <CreateReleaseWatchRequestBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct CreateReleaseWatchRequestBuilder {
...
impl CreateReleaseWatchRequestBuilder {
    ...
    /// Consumes the builder and constructs a [`CreateReleaseWatchRequest`].
    /// This method will fail if any of the following fields are not set:
    /// - [`trace_ids`](CreateReleaseWatchRequestBuilder::trace_ids)
    pub fn build(self) -> Result<CreateReleaseWatchRequest, BuildError> {
        Ok(CreateReleaseWatchRequest {
